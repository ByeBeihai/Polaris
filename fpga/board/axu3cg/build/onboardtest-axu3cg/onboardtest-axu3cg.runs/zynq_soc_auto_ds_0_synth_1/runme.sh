...
HD_PWD='/home/stu/NutShell/fpga/board/axu3cg/build/onboardtest-axu3cg/onboardtest-axu3cg.runs/zynq_soc_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_soc_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_soc_auto_ds_0.tcl
